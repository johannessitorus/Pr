...
@section('title', 'Tambah Jenis Dokumen Baru')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h1 class="mb-0 h3">Tambah Jenis Dokumen Baru</h1>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.jenis-dokumen.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_jenis') is-invalid @enderror" id="nama_jenis" name="nama_jenis" value="{{ old('nama_jenis') }}" required autofocus>
                            @error('nama_jenis')
                        ...
                        <div class="mt-4 d-flex justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i> Simpan Jenis Dokumen
                            </button>
                        </div>
                    </form>
                </div>
